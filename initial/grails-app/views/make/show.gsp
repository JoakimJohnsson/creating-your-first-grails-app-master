...
<body>
<a href="#show-make" class="visually-hidden-focusable" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
...
<div id="show-make" class="content scaffold-show" role="main">
    ...
    <f:display bean="make"/>
    <g:form resource="${this.make}" method="DELETE">
        <fieldset class="buttons">
            <g:link class="edit" action="edit" resource="${this.make}"><g:message code="default.button.edit.label" default="Edit"/></g:link>
